...
var globalDefaultsNodeIndex = 62
_mq(0, 0, ["message"])
_sp(0, 1) // %0G<W>
_ptr(0, 0, ["pointer"]) // %1G
...
_v({src: "resources/images/ic_arrow_forward_48px.svg", size: "100%"}, false) // %29G
...
_v({image: {src: "resources/images/flip-logo.png", size: "100%"}}, false) // %52G
...
_v({src: "resources/images/ic_arrow_back_48px.svg", size: "100%"}, false) // %57G
_v({src: "../../common/design/img/ic_arrow_forward_48px.svg", size: "100%"}, false) // %58G
_v(["settings"], undefined) // %59G
_v([{darkColor: [_]}], undefined) // %60G
_v([{darkPrimaryColor: ["#0097A7"], lightPrimaryColor: ["#B2EBF2"], primaryColor: ["#00BCD4"], accentColor: ["#CDDC39"], textPrimaryColor: ["#FFFFFF"], primaryTextColor: ["#212121"], secondaryTextColor: ["#757575"], dividerColor: ["#BDBDBD"], darkColor: ["hsl(200,50%,50%)"], darkIndirectHoverColor: ["hsl(200,40%,90%)"], darkHoverColor: ["hsl(200,40%,90%)"], lightColor: ["hsl(200,0%,100%)"], lightIndirectHoverColor: ["hsl(200,40%,65%)"], lightHoverColor: ["hsl(200,40%,65%)"], tileColorDarker: ["hsl(200,80%,40%)"], bgColor: ["hsl(45, 73%, 63%)"], bgColor1: ["hsl(45, 56%, 75%)"], minMoveColor: ["#29CB29"], moveColor: ["#2894CB"], undoColor: ["#FF4C4C"], highlightColor: ["hsl(200,50%,50%)"]}], undefined) // %61G
_w(0, 0, ["globalDefaults"], _n(undefined,61),false) // %62G
_f(1, 0, internalApply, [_n(undefined,60), _n(undefined,62)]) // %63G
_v(16, true) // %64G
_v({textAlign: "left", lineHeight: 1.25, value: "The goal of this puzzle is to make all tiles blue. You can change the color of a tile by clicking on it. However, when you do so, surrounding tiles also change color.<br><br>In game type 'flip1', the cells directly touching in horizontal and vertical direction change color, irrespective of their state.In game type 'flip2', all cells in the same row and column up until (and including) the first tile with another color flip.<br><br>Have fun.", color: "white", fontFamily: "Roboto", fontWeight: 300}, false) // %65G
_a(2, 0, {background:_nf(undefined,63), paddingLeft:_n(undefined,64), paddingRight:_n(undefined,64), html:_n(undefined,65)}, false) // %66G
_v(64, true) // %67G
_v({point1: {type: "left"}, point2: {type: "right"}, equals: 450, priority: -1}, false) // %68G
_v("left", true) // %69G
_v(8, true) // %70G
_a(0, 0, {Settings:_n(undefined,26), LTRContainer:_n(undefined,26)}, false) // %71G
_v({src: "../../common/design/img/ic_arrow_back_48px.svg", size: "100%"}, false) // %72G
_v(["game"], undefined) // %73G
_v([{tileColorDarker: [_]}], undefined) // %74G
_f(1, 0, internalApply, [_n(undefined,74), _n(undefined,62)]) // %75G
_v({value: "Start configuration", color: "white", fontFamily: "Roboto", fontWeight: 300}, false) // %76G
_a(2, 0, {background:_nf(undefined,75), text:_n(undefined,76)}, false) // %77G
_v("bottom", true) // %78G
_v({type: "top"}, false) // %79G
_v([8], undefined) // %80G
_f(0, 0, empty, [_n(undefined,80)]) // %81G
_co(1, 0, _n(undefined,81), [{on:_n(undefined,26), use:_n(undefined,12)}, {on:_n(undefined,31), use:_n(undefined,80)}]) // %82G
_a(0, 0, {Configurations:_n(undefined,26), BasicListInAreaWithScrollbar:_n(undefined,26), BasicListInArea:_n(undefined,26), WheelScroll:_n(undefined,26)}, false) // %83G
_v([{point1: [{type: ["top"]}], point2: [{type: ["top"]}]}], undefined) // %84G
_v([{equals: [0]}], undefined) // %85G
_v("top", false) // %86G
_v({point1: {type: "top"}, point2: {type: "bottom"}, equals: 0}, false) // %87G
_v(undefined, true) // %88G
_v([{type: ["Wheel"]}], undefined) // %89G
_v([{deltaY: [_]}], undefined) // %90G
_v([1], undefined) // %91G
_v(152, true) // %92G
_v(8, false) // %93G
_v(0, false) // %94G
_v({type: "top", element: [new ElementReference("p1")]}, false) // %95G
_v([-15], undefined) // %96G
_v([{element: [new ElementReference("p1")], type: ["top"]}], undefined) // %97G
_v([{darkHoverColor: [_]}], undefined) // %98G
_f(1, 0, internalApply, [_n(undefined,98), _n(undefined,62)]) // %99G
_v(4, true) // %100G
_v([{category: [_]}], undefined) // %101G
_v("white", true) // %102G
_v("Roboto", true) // %103G
_v(300, true) // %104G
_v(24, true) // %105G
_a(0, 0, {BasicListInAreaWithScrollbar:_n(undefined,26), BasicListInArea:_n(undefined,26)}, false) // %106G
_v(116, true) // %107G
_v({point1: {type: "left"}, point2: {type: "right"}, min: 0}, false) // %108G
_v("solid", false) // %109G
_v("none", false) // %110G
_v([{bgColor1: [_]}], undefined) // %111G
_f(1, 0, internalApply, [_n(undefined,111), _n(undefined,62)]) // %112G
_v({type: "left", element: [new ElementReference("p1")]}, false) // %113G
_v(15, true) // %114G
_v([{element: [new ElementReference("p1")], type: ["left"]}], undefined) // %115G
_v(2, true) // %116G
_v("solid", true) // %117G
_v("#E6C35C", true) // %118G
_v("white", false) // %119G
_v("darkgrey", false) // %120G
_a(0, 0, {InvertROCell:_n(undefined,26), FixedMatrixCell:_n(undefined,26)}, false) // %121G
_v([{areaSetAttr: [_]}], undefined) // %122G
_v([18], undefined) // %123G
_v([6], undefined) // %124G
_v(18, true) // %125G
_a(0, 0, {BasicHScrollBar:_n(undefined,26), BasicScrollBar:_n(undefined,26), Clickable:_n(undefined,26)}, false) // %126G
_v(1, true) // %127G
_v("vertical-center", false) // %128G
_v(-15, true) // %129G
_v([{pointerInArea: [_]}], undefined) // %130G
_v(0.6, false) // %131G
_v(0.3, false) // %132G
_v("lightgrey", false) // %133G
_v(3, false) // %134G
_a(0, 0, {BasicHScrollBarThumb:_n(undefined,26), BasicScrollBarThumb:_n(undefined,26), Draggable:_n(undefined,26), Clickable:_n(undefined,26)}, false) // %135G
_v([20], undefined) // %136G
_a(0, 0, {BasicScrollBar:_n(undefined,26), Clickable:_n(undefined,26), BasicVScrollBar:_n(undefined,26)}, false) // %137G
_v("horizontal-center", false) // %138G
_a(0, 0, {BasicScrollBarThumb:_n(undefined,26), Draggable:_n(undefined,26), Clickable:_n(undefined,26), BasicVScrollBarThumb:_n(undefined,26)}, false) // %139G
_v("top", true) // %140G
_v({type: "bottom"}, false) // %141G
_v({value: "Game Type", color: "white", fontFamily: "Roboto", fontWeight: 300}, false) // %142G
_a(2, 0, {background:_nf(undefined,75), text:_n(undefined,142)}, false) // %143G
_a(0, 0, {FixedMatrix:_n(undefined,26)}, false) // %144G
_v(40, true) // %145G
_v([{highlightColor: [_]}], undefined) // %146G
_f(1, 0, internalApply, [_n(undefined,146), _n(undefined,62)]) // %147G
_v([{lightHoverColor: [_]}], undefined) // %148G
_f(1, 0, internalApply, [_n(undefined,148), _n(undefined,62)]) // %149G
_v(["underline"], undefined) // %150G
_a(0, 0, {FixedMatrixCell:_n(undefined,26)}, false) // %151G
_f(0, 0, size, [_n(undefined,19)]) // %152G
_v([24], undefined) // %153G
_v([{content: [true], type: ["left"]}], undefined) // %154G
_v([{content: [true], type: ["right"]}], undefined) // %155G
_f(1, 0, minus, [_n(undefined,152), _n(undefined,91)]) // %156G
_v([32], undefined) // %157G
_f(2, 0, mul, [_n(undefined,156), _n(undefined,157)]) // %158G
_f(3, 0, plus, [_n(undefined,158), _n(undefined,157)]) // %159G
_v([16], undefined) // %160G
_v({value: "Board size", color: "white", fontFamily: "Roboto", fontWeight: 300}, false) // %161G
_a(2, 0, {background:_nf(undefined,75), text:_n(undefined,161)}, false) // %162G
_v([{point1: [{type: ["left"]}], point2: [{type: ["left"]}]}], undefined) // %163G
_v([{height: [_], width: [_]}], undefined) // %164G
_a(2, 0, {background:_nf(undefined,63), borderWidth:_n(undefined,116), borderStyle:_n(undefined,117), borderColor:_n(undefined,118)}, false) // %165G
_v("lightgrey", true) // %166G
_v(3, true) // %167G
_a(0, 0, {LTRContainer:_n(undefined,26)}, false) // %168G
_a(0, 0, {GameState:_n(undefined,26)}, false) // %169G
_v(48, true) // %170G
_v([{msg: ["Invert"], recipient: ["start"]}], undefined) // %171G
_f(1, 0, internalApply, [_n(undefined,171), _n(undefined,0)])
_sp(0, 1) // %172G
_v([{msg: ["Revert"], recipient: ["start"]}], undefined) // %173G
_f(1, 0, internalApply, [_n(undefined,173), _n(undefined,0)])
_sp(0, 1) // %174G
_v({text: {textAlign: "right", value: "# moves", color: "white", fontFamily: "Roboto", fontWeight: 300}}, false) // %175G
_v(90, true) // %176G
_v(20, true) // %177G
_a(0, 0, {CircleCount:_n(undefined,26)}, false) // %178G
_v(100, true) // %179G
_v(700, true) // %180G
_a(0, 0, {ZAboveSiblings:_n(undefined,26)}, false) // %181G
_v(80, true) // %182G
_v([{minMoveColor: [_]}], undefined) // %183G
_f(1, 0, internalApply, [_n(undefined,183), _n(undefined,62)]) // %184G
_v([{moveColor: [_]}], undefined) // %185G
_f(1, 0, internalApply, [_n(undefined,185), _n(undefined,62)]) // %186G
_v([10], undefined) // %187G
_a(0, 0, {Circle:_n(undefined,26)}, false) // %188G
_v({text: {textAlign: "right", value: "# undo", color: "white", fontFamily: "Roboto", fontWeight: 300}}, false) // %189G
_v(22, true) // %190G
_v(["green"], undefined) // %191G
_v([{undoColor: [_]}], undefined) // %192G
_f(1, 0, internalApply, [_n(undefined,192), _n(undefined,62)]) // %193G
_a(0, 0, {Invert:_n(undefined,26), FixedMatrix:_n(undefined,26)}, false) // %194G
_v([5], undefined) // %195G
_v([{column: [_]}], undefined) // %196G
_f(1, 0, internalApply, [_n(undefined,196), _n(undefined,0)])
_sp(0, 1) // %197G
_v([{row: [_]}], undefined) // %198G
_f(1, 0, internalApply, [_n(undefined,198), _n(undefined,0)])
_sp(0, 1) // %199G
_v([-1], undefined) // %200G
_rco(0, 0, [_n(undefined,12), _n(undefined,200)])
_sp(0, 1) // %201G
_v([{darkIndirectHoverColor: [_]}], undefined) // %202G
_f(1, 0, internalApply, [_n(undefined,202), _n(undefined,62)]) // %203G
_v([{lightIndirectHoverColor: [_]}], undefined) // %204G
_f(1, 0, internalApply, [_n(undefined,204), _n(undefined,62)]) // %205G
_v([{lightColor: [_]}], undefined) // %206G
_f(1, 0, internalApply, [_n(undefined,206), _n(undefined,62)]) // %207G
_v({skew: {x: -40, y: -20}}, false) // %208G
_v({skew: {x: -20, y: -10}}, false) // %209G
_a(0, 0, {InvertCell:_n(undefined,26), InvertROCell:_n(undefined,26), FixedMatrixCell:_n(undefined,26)}, false) // %210G
_v(["Invert"], undefined) // %211G
_v(["start"], undefined) // %212G
_v({src: "resources/images/ic_undo_48px.svg", size: "100%"}, false) // %213G
_a(0, 0, {IconButton:_n(undefined,26), DepressWhileMouseDown:_n(undefined,26), Clickable:_n(undefined,26)}, false) // %214G
_v([{msg: ["Revert"]}], undefined) // %215G
_v({src: "resources/images/ic_settings_backup_restore_48px.svg", size: "100%"}, false) // %216G
...
_sp(0, 1) // %45L1
_f(3, 0, minus, [_n(undefined,124), _n(0,45)]) // %46L1
_f(4, 0, mul, [_n(0,46), _n(undefined,123)]) // %47L1
_f(5, 0, div, [_n(0,47), _n(undefined,22)]) // %48L1
_f(3, 0, minus, [_n(undefined,124), _n(0,44)]) // %49L1
_f(4, 0, mul, [_n(0,49), _n(undefined,123)]) // %50L1
_f(5, 0, div, [_n(0,50), _n(undefined,22)]) // %51L1
_q(4, 0, [[_g(_n(0,5), false)]]) // %52L1
_m1(5, 0, _n(0,52), _n(undefined,108)) // %53L1
...
_f(2, 0, internalApply, [_n(undefined,73), _n(0,11)]) // %57L1
...
_f(5, 0, mul, [_n(undefined,195), _n(0,63)]) // %64L1
_f(6, 0, plus, [_n(0,64), _n(undefined,195)]) // %65L1
...
_sp(0, 1) // %69L1
_f(3, 0, minus, [_n(0,44), _n(undefined,91)])
_sp(0, 1) // %70L1
...
_par(0, 0, ["param"]) // %1L6
_f(1, 0, me, []) // %2L6
_a(2, 0, {type:_n(undefined,69), element:_n(0,2)}, false) // %3L6
_a(3, 0, {point1:_n(0,3), point2:_n(undefined,47), min:_n(undefined,70)}, false) // %4L6
_a(2, 0, {type:_n(undefined,54), element:_n(0,2)}, false) // %5L6
_a(3, 0, {point1:_n(undefined,47), point2:_n(0,5), min:_n(undefined,70)}, false) // %6L6
...
_a(4, 0, {image:_n(undefined,58), filter:_n(undefined,30), padding:_nf(0,4)}, false) // %5L8
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %6L8
_q(2, 0, [[_g(_n(0,2), false)]])
_sp(0, 1) // %7L8
...
_aw(8, "onClick", _n(0,6), undefined, {switch:_tm(_n(2,11), _n(undefined,59), 3)}, undefined, undefined, 2)
...
_par(0, 0, ["param"]) // %1L9
_cnp(undefined)
_ae(9, _n(undefined,66), {"horizontal-center":_n(undefined,45), top:_n(undefined,67), bottom:_n(undefined,34), preferredWidth:_n(undefined,68), leftInsideEmbedding:_n(1,4), rightInsideEmbedding:_n(1,6)}, undefined, undefined) // area template expr 9
...
_a(3, 0, {type:_n(undefined,78), element:_n(0,3)}, false) // %4L10
_a(4, 0, {point1:_n(0,4), point2:_n(undefined,79), equals:_nt(undefined,82)}, false) // %5L10
_d(3, 0, "configText", _n(0,2)) // %6L10
_a(4, 0, {type:_n(undefined,78), element:_n(0,6)}, false) // %7L10
_a(5, 0, {point1:_n(0,7), point2:_n(undefined,79), equals:_nt(undefined,82)}, false) // %8L10
_a(2, 0, {type:_nf(undefined,86), element:_n(0,2)}, false) // %9L10
_a(2, 0, {element:_n(0,2), type:_n(undefined,17)}, undefined)
_sp(0, 1) // %10L10
_d(2, 0, "gameTypeText", _n(0,2)) // %11L10
_a(3, 0, {type:_n(undefined,78), element:_n(0,11)}, false) // %12L10
_a(4, 0, {point1:_n(0,12), point2:_n(undefined,79), equals:_nt(undefined,82)}, false) // %13L10
_d(2, 0, "gameType", _n(0,2)) // %14L10
_a(3, 0, {type:_n(undefined,78), element:_n(0,14)}, false) // %15L10
_a(4, 0, {point1:_n(0,15), point2:_n(undefined,79), equals:_nt(undefined,82)}, false) // %16L10
_d(2, 0, "boardSizeText", _n(0,2)) // %17L10
_a(3, 0, {type:_n(undefined,78), element:_n(0,17)}, false) // %18L10
_a(4, 0, {point1:_n(0,18), point2:_n(undefined,79), equals:_nt(undefined,82)}, false) // %19L10
_cnp({"Settings":1,"LTRContainer":2})
_ae(10, _n(undefined,41), {left:_n(1,30), anchorLeftToEmbedding:_n(1,33), anchorLRightToEmbedding:_n(1,34), top:_n(undefined,45), bottom:_n(undefined,45), stableWidth:_n(undefined,48)}, undefined, {"0":_n(undefined,71)}) // area template expr 10
...
_a(4, 0, {image:_n(undefined,72), filter:_n(undefined,30), padding:_nf(0,4)}, false) // %5L11
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %6L11
_q(2, 0, [[_g(_n(0,2), false)]])
_sp(0, 1) // %7L11
...
_a(4, 0, {image:_n(undefined,58), filter:_n(undefined,30), padding:_nf(0,4)}, false) // %5L12
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %6L12
_q(2, 0, [[_g(_n(0,2), false)]])
_sp(0, 1) // %7L12
...
_aw(12, "onClick", _n(0,6), undefined, {switch:_tm(_n(2,11), _n(undefined,73), 3)}, undefined, undefined, 2)
...
_aeq([[_g(_n(2,2), true)]])
_cnp(undefined)
_ae(13, _n(undefined,77), {left:_n(undefined,34), right:_n(undefined,34), height:_n(undefined,34), top:_n(1,5)}, undefined, undefined) // area template expr 13
...
_m(14, 0, _n(0,13), [_n(undefined,2), _n(undefined,84), _n(0,15), _n(undefined,85)])
_se(14, 0) // %16L14
_q(13, 0, [[_g(_n(0,12), false)]])
_sp(0, 1)
_se(13, 0) // %17L14
_d(14, 0, "scrollbar", _n(0,4)) // %18L14
_a(15, 0, {type:_nf(undefined,86), element:_n(0,18)}, false) // %19L14
_d(15, 0, "thumb", _n(0,18)) // %20L14
_a(16, 0, {type:_nf(undefined,86), element:_n(0,20)}, false) // %21L14
_a(17, 0, {point1:_nf(0,19), point2:_nf(0,21)}, false) // %22L14
_a(9, 0, {type:_nf(undefined,86), element:_n(0,6)}, false) // %23L14
_a(10, 0, {point1:_nf(undefined,79), point2:_nf(0,23)}, false) // %24L14
...
_sp(0, 1) // %31L14<W>
_a(4, 0, {point1:_nf(1,9), point2:_nf(undefined,79), equals:_nt(0,31)}, false) // %32L14
_m1(5, 0, _n(0,30), _n(0,32)) // %33L14
_f(3, 0, internalApply, [_n(undefined,89), _n(0,0)])
_sp(0, 1) // %34L14
_f(3, 0, offset, [_n(1,10), _n(undefined,15)])
_sp(0, 1)
_se(3, 0) // %35L14
_f(3, 0, internalApply, [_n(undefined,90), _n(0,0)])
_sp(0, 1) // %36L14
...
_q(13, 0, [[_g(_n(0,12), false)], []])
_se(13, 0) // %41L14
_m(14, 0, _n(0,41), [_n(undefined,93), _n(undefined,94)])
_se(14, 0) // %42L14
_m1(14, 0, _n(0,17), _n(undefined,15))
_sp(0, 1)
_se(14, 0) // %43L14
_m1(14, 0, _n(0,17), _n(undefined,96))
_se(14, 0) // %44L14
_a(4, 0, {type:_nf(undefined,86), element:_n(0,4)}, false) // %45L14
_a(4, 0, {element:_n(0,4), type:_n(undefined,17)}, undefined)
_sp(0, 1) // %46L14
_m1(14, 0, _n(0,17), _n(undefined,91))
_sp(0, 1)
_se(14, 0) // %47L14
...
_se(13, 0) // %51L14
_f(14, 0, max, [_n(0,51), _n(undefined,136)])
_se(14, 0) // %52L14
_aeq([[_g(_n(2,2), true)]])
...
_ae(14, undefined, {left:_n(undefined,34), right:_n(undefined,34), bottom:_n(undefined,34), top:_n(1,8), firstChild:_n(0,16), firstChildTopOppositeThumb:_n(0,28), minHeightZero:_n(2,36), minWidthZero:_n(undefined,88), jumpToLabel:_n(0,33)}, undefined, {"0":_n(undefined,83)}) // area template expr 14
_aw(14, "blockWheelEvt", _n(0,34), _n(undefined,31), {}, undefined, undefined, 5)
_aw(14, "onWheel", _n(0,34), undefined, {setWheelOffset:_tm(_n(0,31), _n(0,37), 5),initWheelScroll:_tm(_n(0,29), _n(undefined,91), 5)}, undefined, {setWheelOffset:_tm(_n(0,29), _n(undefined,22), 5)}, 4)
...
_sp(0, 1)
_se(14, 0) // %9L15<W>
_a(15, 0, {point1:_nf(1,43), point2:_nf(undefined,95), equals:_nt(0,9), priority:_nt(1,44)}, false)
_se(15, 0) // %10L15
...
_sp(0, 1)
_se(14, 0) // %16L15<W>
_a(15, 0, {point1:_nf(1,45), point2:_nf(undefined,79), equals:_nt(0,16)}, false)
_se(15, 0) // %17L15
_m1(16, 0, _n(0,14), _n(0,17))
_se(16, 0) // %18L15
_f(7, 0, prev, []) // %19L15
_a(8, 0, {type:_n(undefined,78), element:_n(0,19)}, false) // %20L15
_a(9, 0, {point1:_n(0,20), point2:_n(undefined,79), equals:_n(undefined,45)}, false) // %21L15
...
_sp(0, 1)
_se(17, 0) // %25L15<W>
_f(15, 0, offset, [_n(1,43), _n(undefined,97)])
_sp(0, 1)
_se(15, 0) // %26L15
...
_sp(0, 1)
_se(16, 0) // %35L15
_f(7, 0, internalApply, [_n(undefined,89), _n(0,0)])
_sp(0, 1) // %36L15
...
_sp(0, 1)
_se(7, 0) // %39L15
_f(7, 0, internalApply, [_n(undefined,90), _n(0,0)])
_sp(0, 1) // %40L15
...
_sp(0, 1)
_se(16, 0) // %45L15
_f(8, 0, internalApply, [_n(undefined,101), _n(0,2)]) // %46L15
_f(9, 0, first, [_n(0,46)]) // %47L15
_a(10, 0, {value:_nf(0,47), color:_n(undefined,102), fontFamily:_n(undefined,103), fontWeight:_n(undefined,104)}, false) // %48L15
_a(11, 0, {background:_nf(undefined,99), padding:_n(undefined,100), text:_n(0,48)}, false) // %49L15
_q(9, 0, [[_g(_n(0,3), false)]]) // %50L15
_m1(10, 0, _n(0,50), _n(undefined,108)) // %51L15
_cnp({"ConfigurationListItem":1,"Draggable":2,"Clickable":3,"WheelScroll":4})
_ae(15, undefined, {height:_n(undefined,92), right:_n(1,42), topDrag:_n(0,11), leftDrag:_n(undefined,88), jumpToLabel:_n(0,18), left:_n(undefined,45), itemOrder:_n(0,21)}, undefined, {"0":_n(1,40)}) // area template expr 15
...
_par(0, 0, ["param"]) // %1L16
_cnp(undefined)
_ae(16, _n(1,49), {top:_n(undefined,100), left:_n(undefined,45), height:_n(undefined,105), right:_n(undefined,45)}, undefined, undefined) // area template expr 16
...
_q(16, 0, [[_g(_n(0,12), false)], []])
_se(16, 0) // %29L17
_m(17, 0, _n(0,29), [_n(undefined,93), _n(undefined,94)])
_se(17, 0) // %30L17
_m1(17, 0, _n(0,13), _n(undefined,10))
_sp(0, 1)
_se(17, 0) // %31L17
_m1(17, 0, _n(0,13), _n(undefined,96))
_se(17, 0) // %32L17
_a(8, 0, {type:_nf(undefined,86), element:_n(0,4)}, false) // %33L17
_a(8, 0, {element:_n(0,4), type:_n(undefined,17)}, undefined)
_sp(0, 1) // %34L17
_m1(17, 0, _n(0,13), _n(undefined,91))
_sp(0, 1)
_se(17, 0) // %35L17
...
_se(16, 0) // %39L17
_f(17, 0, max, [_n(0,39), _n(undefined,136)])
_se(17, 0) // %40L17
_cnp({"BasicListInAreaWithScrollbar":1,"BasicListInArea":2})
_acc(17, {"items":{data:_n(1,3),partner:undefined}})
_ae(17, undefined, {top:_n(undefined,34), left:_n(undefined,34), right:_n(undefined,34), height:_n(undefined,107), firstChild:_n(0,14), firstChildTopOppositeThumb:_n(0,25), minHeightZero:_n(undefined,88), minWidthZero:_n(1,51)}, undefined, {"0":_n(undefined,106)}) // area template expr 17
...
_m(13, 0, _n(0,5), [_n(undefined,109), _n(undefined,110)]) // %6L18
_q(12, 0, [[_g(_n(0,4), true)]]) // %7L18
_m1(13, 0, _n(0,7), _n(undefined,112)) // %8L18
_a(14, 0, {borderStyle:_nf(0,6), background:_nf(0,8), borderRadius:_n(undefined,70), borderColor:_nf(undefined,99), borderWidth:_n(undefined,100)}, false) // %9L18
...
_sp(0, 1)
_se(17, 0) // %15L18<W>
_a(18, 0, {point1:_nf(1,31), point2:_nf(undefined,113), equals:_nt(0,15), priority:_nt(1,32)}, false)
_se(18, 0) // %16L18
...
_sp(0, 1)
_se(17, 0) // %22L18<W>
_a(18, 0, {point1:_nf(1,33), point2:_nf(undefined,79), equals:_nt(0,22)}, false)
_se(18, 0) // %23L18
_m1(19, 0, _n(0,20), _n(0,23))
_se(19, 0) // %24L18
_f(10, 0, prev, []) // %25L18
_a(11, 0, {type:_n(undefined,54), element:_n(0,25)}, false) // %26L18
_a(12, 0, {point1:_n(0,26), point2:_n(undefined,44), equals:_n(undefined,114)}, false) // %27L18
...
_sp(0, 1)
_se(20, 0) // %32L18<W>
_f(18, 0, offset, [_n(1,31), _n(undefined,115)])
_sp(0, 1)
_se(18, 0) // %33L18
...
_sp(0, 1)
_se(19, 0) // %42L18
_f(10, 0, internalApply, [_n(undefined,89), _n(0,0)])
_sp(0, 1) // %43L18
...
_sp(0, 1)
_se(10, 0) // %46L18
_f(10, 0, internalApply, [_n(undefined,90), _n(0,0)])
_sp(0, 1) // %47L18
...
_ae(18, _n(0,9), {height:_n(undefined,107), width:_n(undefined,107), bottom:_n(1,30), topDrag:_n(undefined,88), leftDrag:_n(0,17), jumpToLabel:_n(0,24), top:_n(undefined,45), itemOrder:_n(0,27)}, undefined, {"0":_n(1,28)}) // area template expr 18
_aw(18, "onClick", _n(0,28), undefined, {updateSelectedConfiguration:_tm(_n(5,8), _n(0,2), 12),resetBoard:_tm(_n(5,39), _n(0,3), 12),clearHistory:_tm(_n(5,40), _n(undefined,2), 12),showInvertBoard:_tm(_n(5,11), _n(undefined,73), 12),resetNrMoves:_tm(_n(5,42), _n(undefined,12), 12),resetUndoCount:_tm(_n(5,43), _n(undefined,12), 12)}, undefined, undefined, 11)
...
_m(15, 0, _n(0,3), [_n(undefined,119), _n(undefined,63), _n(undefined,120)]) // %4L19
_a(16, 0, {borderWidth:_n(undefined,116), borderStyle:_n(undefined,117), borderColor:_n(undefined,118), background:_nf(0,4)}, false) // %5L19
_f(13, 0, internalApply, [_n(undefined,122), _n(0,1)]) // %6L19
_f(14, 0, div, [_n(0,6), _n(6,44)]) // %7L19
_f(15, 0, floor, [_n(0,7)]) // %8L19
_f(16, 0, mul, [_n(0,8), _n(undefined,123)]) // %9L19
_f(17, 0, plus, [_n(0,9), _n(6,48)]) // %10L19
_f(14, 0, mod, [_n(0,6), _n(6,44)]) // %11L19
_f(15, 0, mul, [_n(0,11), _n(undefined,123)]) // %12L19
_f(16, 0, plus, [_n(0,12), _n(6,51)]) // %13L19
_cnp({"InvertROCell":1,"FixedMatrixCell":2})
_ae(19, _n(0,5), {top:_n(0,10), left:_n(0,13), height:_n(undefined,125), width:_n(undefined,125)}, undefined, {"0":_n(undefined,121)}) // area template expr 19
...
_a(19, 0, {type:_nf(undefined,128), element:_n(0,5)}, false) // %6L20
_a(20, 0, {point1:_nf(0,6), point2:_nf(undefined,113), equals:_nt(undefined,45), priority:_nt(undefined,129)}, false) // %7L20
...
_sp(0, 1) // %16L20
_a(18, 0, {type:_n(undefined,69), element:_n(0,4)}, false) // %17L20
...
_ae(20, undefined, {bottom:_n(undefined,45), left:_n(undefined,45), right:_n(undefined,127), height:_n(undefined,70), moveScrollBar:_n(0,8)}, undefined, {"0":_n(undefined,126)}) // area template expr 20
...
_sp(0, 1) // %0L21
_par(0, 0, ["param"]) // %1L21
_f(17, 0, internalApply, [_n(undefined,130), _n(0,1)]) // %2L21
_w(17, 0, ["context","selected"], _n(undefined,31),true)
_sp(0, 1) // %3L21<W>
_f(18, 0, or, [_n(0,2), _n(0,3)]) // %4L21
_q(19, 0, [[_g(_n(0,4), true)], []]) // %5L21
_m(20, 0, _n(0,5), [_n(undefined,131), _n(undefined,132)]) // %6L21
_a(21, 0, {opacity:_nf(0,6), background:_n(undefined,133), borderRadius:_n(undefined,134)}, false) // %7L21
_q(18, 0, [[_g(_n(0,3), true)]]) // %8L21
_w(17, 0, ["context","mouseDownX"], _n(undefined,12),true)
_sp(0, 1) // %9L21<W>
_a(18, 0, {point1:_nf(undefined,10), point2:_nf(undefined,113), equals:_nt(0,9), priority:_nt(undefined,96)}, false) // %10L21
...
_sp(0, 1) // %15L21<W>
_f(17, 0, offset, [_n(undefined,10), _n(undefined,115)])
_sp(0, 1)
_se(17, 0) // %16L21
...
_ae(21, _n(0,7), {left:_n(1,18), right:_n(1,20), top:_n(undefined,12), width:_n(2,40), bottom:_n(undefined,12), topDrag:_n(undefined,88), leftDrag:_n(0,11)}, undefined, {"0":_n(undefined,135)}) // area template expr 21
...
_a(16, 0, {type:_nf(undefined,138), element:_n(0,5)}, false) // %6L22
_a(17, 0, {point1:_nf(0,6), point2:_nf(undefined,95), equals:_nt(undefined,45), priority:_nt(undefined,129)}, false) // %7L22
...
_sp(0, 1) // %16L22
_a(15, 0, {type:_n(undefined,140), element:_n(0,4)}, false) // %17L22
_a(16, 0, {point1:_n(0,17), point2:_n(undefined,79), min:_n(undefined,45)}, false) // %18L22
_a(15, 0, {type:_n(undefined,78), element:_n(0,4)}, false) // %19L22
_a(16, 0, {point1:_n(undefined,141), point2:_n(0,19), min:_n(undefined,45)}, false) // %20L22
_aeq([[_g(_n(1,12), false)]])
_cnp({"BasicScrollBar":1,"Clickable":2,"BasicVScrollBar":3})
_ae(22, undefined, {bottom:_n(undefined,127), right:_n(undefined,45), moveScrollBar:_n(0,8), top:_n(undefined,45), width:_n(undefined,70)}, undefined, {"0":_n(undefined,137)}) // area template expr 22
...
_sp(0, 1) // %0L23
_par(0, 0, ["param"]) // %1L23
_f(14, 0, internalApply, [_n(undefined,130), _n(0,1)]) // %2L23
_w(14, 0, ["context","selected"], _n(undefined,31),true)
_sp(0, 1) // %3L23<W>
_f(15, 0, or, [_n(0,2), _n(0,3)]) // %4L23
_q(16, 0, [[_g(_n(0,4), true)], []]) // %5L23
_m(17, 0, _n(0,5), [_n(undefined,131), _n(undefined,132)]) // %6L23
_a(18, 0, {opacity:_nf(0,6), background:_n(undefined,133), borderRadius:_n(undefined,134)}, false) // %7L23
_q(15, 0, [[_g(_n(0,3), true)]]) // %8L23
_w(14, 0, ["context","mouseDownY"], _n(undefined,12),true)
_sp(0, 1) // %9L23<W>
_a(15, 0, {point1:_nf(undefined,15), point2:_nf(undefined,95), equals:_nt(0,9), priority:_nt(undefined,96)}, false) // %10L23
...
_sp(0, 1) // %15L23<W>
_f(14, 0, offset, [_n(undefined,15), _n(undefined,97)])
_sp(0, 1)
_se(14, 0) // %16L23
...
_ae(23, _n(0,7), {left:_n(undefined,12), right:_n(undefined,12), top:_n(1,18), bottom:_n(1,20), topDrag:_n(0,11), leftDrag:_n(undefined,88), height:_n(2,52)}, undefined, {"0":_n(undefined,139)}) // area template expr 23
...
_par(0, 0, ["param"]) // %1L24
_cnp(undefined)
_ae(24, _n(undefined,143), {top:_n(undefined,67), left:_n(undefined,34), right:_n(undefined,34), height:_n(undefined,34)}, undefined, undefined) // area template expr 24
_ac(10, "gameType", 0, true) // area template create 25
_mq(0, 0, ["message"]) // %0L25
_par(0, 0, ["param"]) // %1L25
_f(1, 0, offset, [_n(undefined,154), _n(undefined,155)])
_se(1, 0) // %2L25
_f(4, 0, minus, [_n(0,2), _n(undefined,159)])
_se(4, 0) // %3L25
_f(5, 0, div, [_n(0,3), _n(undefined,152)])
_se(5, 0) // %4L25
_f(6, 0, plus, [_n(0,4), _n(undefined,157)])
_se(6, 0) // %5L25
_cnp({"FixedMatrix":1})
_acc(25, {"cells":{data:_n(undefined,19),partner:undefined}})
_ae(25, undefined, {left:_n(undefined,34), right:_n(undefined,34), height:_n(undefined,145), top:_n(1,13)}, undefined, {"0":_n(undefined,144)}) // area template expr 25
...
_co(3, 0, _n(0,3), [{on:_n(undefined,26), use:_n(undefined,147)}]) // %4L26
_co(3, 0, _n(0,3), [{on:_n(undefined,26), use:_n(undefined,150)}]) // %5L26
_a(4, 0, {textDecoration:_nf(0,5), value:_nf(0,2), color:_n(undefined,102), fontFamily:_n(undefined,103), fontWeight:_n(undefined,104)}, false) // %6L26
_a(5, 0, {background:_nf(0,4), borderColor:_nf(undefined,149), borderStyle:_n(undefined,117), borderWidth:_n(undefined,116), borderRadius:_n(undefined,100), text:_n(0,6)}, false) // %7L26
_f(1, 0, internalApply, [_n(undefined,122), _n(0,1)]) // %8L26
_f(2, 0, div, [_n(0,8), _n(undefined,152)]) // %9L26
_f(3, 0, floor, [_n(0,9)]) // %10L26
_f(4, 0, mul, [_n(0,10), _n(undefined,153)]) // %11L26
_f(5, 0, plus, [_n(0,11), _n(undefined,12)]) // %12L26
_f(2, 0, mod, [_n(0,8), _n(undefined,152)]) // %13L26
_f(7, 0, mul, [_n(0,13), _n(1,5)])
_se(7, 0) // %14L26
_f(8, 0, plus, [_n(0,14), _n(undefined,160)])
_se(8, 0) // %15L26
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %16L26
_cnp({"FixedMatrixCell":1})
_ae(26, _n(0,7), {top:_n(0,12), left:_n(0,15), height:_n(undefined,105), width:_n(1,4)}, undefined, {"0":_n(undefined,151)}) // area template expr 26
...
_par(0, 0, ["param"]) // %1L27
_cnp(undefined)
_ae(27, _n(undefined,162), {left:_n(undefined,34), right:_n(undefined,34), height:_n(undefined,34), top:_n(1,16)}, undefined, undefined) // area template expr 27
...
_m(12, 0, _n(0,13), [_n(undefined,2), _n(undefined,163), _n(0,15), _n(undefined,85)])
_se(12, 0) // %16L28
_q(11, 0, [[_g(_n(0,12), false)]])
_sp(0, 1)
_se(11, 0) // %17L28
...
_se(17, 0) // %28L28
_f(1, 0, internalApply, [_n(undefined,89), _n(0,0)])
_sp(0, 1) // %29L28
...
_q(11, 0, [[_g(_n(0,12), false)], []])
_se(11, 0) // %32L28
_m(12, 0, _n(0,32), [_n(undefined,93), _n(undefined,94)])
_se(12, 0) // %33L28
_m1(12, 0, _n(0,17), _n(undefined,15))
_sp(0, 1)
_se(12, 0) // %34L28
_m1(12, 0, _n(0,17), _n(undefined,96))
_se(12, 0) // %35L28
_m1(12, 0, _n(0,17), _n(undefined,10))
_sp(0, 1)
_se(12, 0) // %36L28
_a(2, 0, {type:_nf(undefined,86), element:_n(0,4)}, false) // %37L28
_a(2, 0, {element:_n(0,4), type:_n(undefined,17)}, undefined)
_sp(0, 1) // %38L28
_m1(12, 0, _n(0,17), _n(undefined,91))
_sp(0, 1)
_se(12, 0) // %39L28
...
_se(11, 0) // %43L28
_f(12, 0, max, [_n(0,43), _n(undefined,136)])
_se(12, 0) // %44L28
_cnp({"BasicListInAreaWithScrollbar":1,"BasicListInArea":2})
_acc(28, {"items":{data:_n(2,5),partner:undefined}})
_ae(28, undefined, {left:_n(undefined,34), right:_n(undefined,34), height:_n(undefined,107), top:_n(1,19), firstChild:_n(0,16), firstChildTopOppositeThumb:_n(0,28), minHeightZero:_n(undefined,88), minWidthZero:_n(2,53)}, undefined, {"0":_n(undefined,106)}) // area template expr 28
...
_m(8, 0, _n(0,9), [_n(undefined,109), _n(undefined,110)]) // %10L29
_q(7, 0, [[_g(_n(0,8), true)]]) // %11L29
_m1(8, 0, _n(0,11), _n(undefined,112)) // %12L29
_a(9, 0, {borderStyle:_nf(0,10), background:_nf(0,12), borderRadius:_n(undefined,70), borderColor:_nf(undefined,99), borderWidth:_n(undefined,100)}, false) // %13L29
...
_sp(0, 1)
_se(12, 0) // %19L29<W>
_a(13, 0, {point1:_nf(1,34), point2:_nf(undefined,95), equals:_nt(0,19), priority:_nt(1,35)}, false)
_se(13, 0) // %20L29
...
_sp(0, 1)
_se(12, 0) // %24L29<W>
_a(13, 0, {point1:_nf(1,36), point2:_nf(undefined,113), equals:_nt(0,24), priority:_nt(1,35)}, false)
_se(13, 0) // %25L29
...
_sp(0, 1)
_se(12, 0) // %31L29<W>
_a(13, 0, {point1:_nf(1,37), point2:_nf(undefined,79), equals:_nt(0,31)}, false)
_se(13, 0) // %32L29
_m1(14, 0, _n(0,29), _n(0,32))
_se(14, 0) // %33L29
_f(5, 0, prev, []) // %34L29
_a(6, 0, {type:_n(undefined,54), element:_n(0,34)}, false) // %35L29
_a(7, 0, {point1:_n(0,35), point2:_n(undefined,44), equals:_n(undefined,114)}, false) // %36L29
_f(5, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %37L29
_f(6, 0, internalApply, [_n(undefined,164), _n(0,2)])
_sp(0, 1) // %38L29
...
_sp(0, 1)
_se(15, 0) // %42L29<W>
_f(13, 0, offset, [_n(1,34), _n(undefined,97)])
_sp(0, 1)
_se(13, 0) // %43L29
...
_sp(0, 1)
_se(15, 0) // %46L29<W>
_f(13, 0, offset, [_n(1,36), _n(undefined,115)])
_sp(0, 1)
_se(13, 0) // %47L29
...
_sp(0, 1)
_se(5, 0) // %60L29
_f(5, 0, internalApply, [_n(undefined,90), _n(0,0)])
_sp(0, 1) // %61L29
...
_sp(0, 1)
_se(14, 0) // %66L29
_f(7, 0, minus, [_n(undefined,124), _n(0,4)]) // %67L29
_f(8, 0, mul, [_n(0,67), _n(undefined,123)]) // %68L29
_f(9, 0, div, [_n(0,68), _n(undefined,22)]) // %69L29
_f(7, 0, minus, [_n(undefined,124), _n(0,3)]) // %70L29
_f(8, 0, mul, [_n(0,70), _n(undefined,123)]) // %71L29
_f(9, 0, div, [_n(0,71), _n(undefined,22)]) // %72L29
_cnp({"SimpleInvert":1,"FixedMatrix":2,"Draggable":3,"Clickable":4,"WheelScroll":5})
_acc(29, {"cells":{data:_n(0,7),partner:undefined}})
_ae(29, _n(0,13), {height:_n(undefined,107), width:_n(undefined,107), bottom:_n(1,33), topDrag:_n(0,21), leftDrag:_n(0,26), jumpToLabel:_n(0,33), top:_n(undefined,45), itemOrder:_n(0,36)}, undefined, {"0":_n(1,31)}) // area template expr 29
...
_par(0, 0, ["param"]) // %1L30
_f(11, 0, internalApply, [_n(undefined,122), _n(0,1)]) // %2L30
_f(12, 0, div, [_n(0,2), _n(1,3)]) // %3L30
_f(13, 0, floor, [_n(0,3)]) // %4L30
_f(14, 0, mul, [_n(0,4), _n(undefined,123)]) // %5L30
_f(15, 0, plus, [_n(0,5), _n(1,69)]) // %6L30
_f(12, 0, mod, [_n(0,2), _n(1,3)]) // %7L30
_f(13, 0, mul, [_n(0,7), _n(undefined,123)]) // %8L30
_f(14, 0, plus, [_n(0,8), _n(1,72)]) // %9L30
_cnp({"InvertROCell":1,"FixedMatrixCell":2})
_ae(30, _n(undefined,165), {top:_n(0,6), left:_n(0,9), height:_n(undefined,125), width:_n(undefined,125)}, undefined, {"0":_n(undefined,121)}) // area template expr 30
...
_a(14, 0, {type:_nf(undefined,128), element:_n(0,5)}, false) // %6L31
_a(15, 0, {point1:_nf(0,6), point2:_nf(undefined,113), equals:_nt(undefined,45), priority:_nt(undefined,129)}, false) // %7L31
...
_sp(0, 1) // %16L31
_a(13, 0, {type:_n(undefined,69), element:_n(0,4)}, false) // %17L31
...
_aeq([[_g(_n(1,12), false)]])
_cnp({"BasicHScrollBar":1,"BasicScrollBar":2,"Clickable":3})
_ae(31, undefined, {bottom:_n(undefined,45), left:_n(undefined,45), right:_n(undefined,127), height:_n(undefined,70), moveScrollBar:_n(0,8)}, undefined, {"0":_n(undefined,126)}) // area template expr 31
...
_sp(0, 1) // %0L32
_par(0, 0, ["param"]) // %1L32
_f(12, 0, internalApply, [_n(undefined,130), _n(0,1)]) // %2L32
_w(12, 0, ["context","selected"], _n(undefined,31),true)
_sp(0, 1) // %3L32<W>
_f(13, 0, or, [_n(0,2), _n(0,3)]) // %4L32
_q(14, 0, [[_g(_n(0,4), true)], []]) // %5L32
_m(15, 0, _n(0,5), [_n(undefined,131), _n(undefined,132)]) // %6L32
_a(16, 0, {opacity:_nf(0,6), background:_n(undefined,166), borderRadius:_n(undefined,167)}, false) // %7L32
_q(13, 0, [[_g(_n(0,3), true)]]) // %8L32
_w(12, 0, ["context","mouseDownX"], _n(undefined,12),true)
_sp(0, 1) // %9L32<W>
_a(13, 0, {point1:_nf(undefined,10), point2:_nf(undefined,113), equals:_nt(0,9), priority:_nt(undefined,129)}, false) // %10L32
...
_sp(0, 1) // %15L32<W>
_f(12, 0, offset, [_n(undefined,10), _n(undefined,115)])
_sp(0, 1)
_se(12, 0) // %16L32
...
_sp(0, 1) // %25L32
_cnp({"BasicHScrollBarThumb":1,"BasicScrollBarThumb":2,"Draggable":3,"Clickable":4})
_ae(32, _n(0,7), {left:_n(1,18), right:_n(1,20), top:_n(undefined,12), width:_n(2,44), bottom:_n(undefined,12), topDrag:_n(undefined,88), leftDrag:_n(0,11)}, undefined, {"0":_n(undefined,135)}) // area template expr 32
...
_sp(0, 1) // %5L33
_f(5, 0, and, [_n(undefined,174), _n(0,5)])
_sp(0, 1) // %6L33
...
_a(3, 0, {type:_n(undefined,78), element:_n(0,3)}, false) // %9L33
_a(4, 0, {point1:_n(0,9), point2:_n(undefined,79), equals:_nt(undefined,56)}, false) // %10L33
_d(2, 0, "undoButton", _n(0,2)) // %11L33
_a(3, 0, {type:_n(undefined,140), element:_n(0,11)}, false) // %12L33
_a(4, 0, {point1:_n(0,12), point2:_n(undefined,79), equals:_nt(undefined,56)}, false) // %13L33
_a(3, 0, {type:_n(undefined,69), element:_n(0,11)}, false) // %14L33
...
_sp(0, 1) // %19L33<W>
_cnp({"LTRContainer":1})
_ae(33, _n(undefined,41), {left:_n(1,56), anchorLeftToEmbedding:_n(1,59), anchorLRightToEmbedding:_n(1,60), top:_n(undefined,45), bottom:_n(undefined,45), stableWidth:_n(undefined,48)}, undefined, {"0":_n(undefined,168)}) // area template expr 33
...
_a(4, 0, {image:_n(undefined,72), filter:_n(undefined,30), padding:_nf(0,4)}, false) // %5L34
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %6L34
_q(2, 0, [[_g(_n(0,2), false)]])
_sp(0, 1) // %7L34
...
_aw(34, "onClick", _n(0,6), undefined, {switch:_tm(_n(2,11), _n(undefined,59), 3)}, undefined, undefined, 2)
...
_f(2, 0, plus, [_n(0,2), _n(undefined,91)])
_sp(0, 1) // %8L35
_f(2, 0, minus, [_n(0,2), _n(undefined,91)])
_sp(0, 1) // %9L35
_f(2, 0, plus, [_n(0,5), _n(undefined,91)])
_sp(0, 1) // %10L35
_a(2, 0, {textAlign:_n(undefined,54), fontSize:_n(undefined,177), fontWeight:_n(undefined,180), value:_nf(0,2), color:_n(undefined,102), fontFamily:_n(undefined,103)}, false) // %11L35
_a(3, 0, {text:_n(0,11)}, false) // %12L35
_a(2, 0, {textAlign:_n(undefined,54), fontSize:_n(undefined,177), fontWeight:_n(undefined,180), value:_nf(0,5), color:_n(undefined,102), fontFamily:_n(undefined,103)}, false) // %13L35
_a(3, 0, {text:_n(0,13)}, false) // %14L35
_cnp({"GameState":1})
_ae(35, undefined, {top:_n(undefined,34), left:_n(undefined,67), height:_n(undefined,170), right:_n(undefined,67)}, undefined, {"0":_n(undefined,169), "3":_n(0,2), "4":_n(0,5)}) // area template expr 35
_aw(35, "onInvert", _n(undefined,172), undefined, {registerMove:_tm(_n(0,2), _n(0,8), 3)}, undefined, undefined, 2)
...
_par(0, 0, ["param"]) // %1L36
_cnp(undefined)
_ae(36, _n(undefined,175), {top:_n(undefined,45), left:_n(undefined,45), width:_n(undefined,176), height:_n(undefined,177)}, undefined, undefined) // area template expr 36
...
_ae(37, undefined, {top:_n(undefined,45), left:_n(undefined,179), right:_n(undefined,45), height:_n(undefined,177)}, undefined, {"0":_n(undefined,178)}) // area template expr 37
...
_ae(38, _n(2,12), {top:_n(undefined,45), right:_n(undefined,45), bottom:_n(undefined,45), width:_n(undefined,182)}, {aboveSiblings:_n(0,3)}, {"0":_n(undefined,181)}) // area template expr 38
...
_co(9, 0, _n(0,3), [{on:_n(undefined,26), use:_n(undefined,184)}, {on:_n(undefined,31), use:_n(undefined,186)}]) // %4L39
_f(8, 0, lessThan, [_n(0,2), _n(2,2)]) // %5L39
_co(9, 0, _n(0,5), [{on:_n(undefined,31), use:_n(undefined,80)}, {on:_n(undefined,26), use:_n(undefined,12)}]) // %6L39
_a(10, 0, {color:_nf(0,4), range:_n(undefined,127), radius:_n(undefined,187), start:_n(undefined,45), inset:_nf(0,6)}, false) // %7L39
_a(11, 0, {arc:_n(0,7)}, false) // %8L39
_f(8, 0, mul, [_n(undefined,23), _n(0,2)]) // %9L39
_cnp({"Circle":1})
_ae(39, _n(0,8), {top:_n(undefined,45), left:_n(0,9), width:_n(undefined,177), height:_n(undefined,177)}, undefined, {"0":_n(undefined,188)}) // area template expr 39
_ac(35, "undoCountLabel", 0, true) // area template create 40
_mq(0, 0, ["message"]) // %0L40
_par(0, 0, ["param"]) // %1L40
_cnp(undefined)
_ae(40, _n(undefined,189), {top:_n(undefined,190), left:_n(undefined,45), width:_n(undefined,176), height:_n(undefined,177)}, undefined, undefined) // area template expr 40
...
_ae(41, undefined, {top:_n(undefined,105), left:_n(undefined,179), right:_n(undefined,45), height:_n(undefined,177)}, undefined, {"0":_n(undefined,178)}) // area template expr 41
...
_aeq([[_g(_n(1,6), true)]])
_cnp({"ZAboveSiblings":1})
_ae(42, _n(2,14), {top:_n(undefined,45), right:_n(undefined,45), bottom:_n(undefined,45), width:_n(undefined,182)}, {aboveSiblings:_n(0,3)}, {"0":_n(undefined,181)}) // area template expr 42
...
_co(7, 0, _n(0,3), [{on:_n(undefined,26), use:_n(undefined,191)}, {on:_n(undefined,31), use:_n(undefined,193)}]) // %4L43
_f(6, 0, lessThan, [_n(0,2), _n(2,5)]) // %5L43
_co(7, 0, _n(0,5), [{on:_n(undefined,31), use:_n(undefined,80)}, {on:_n(undefined,26), use:_n(undefined,12)}]) // %6L43
_a(8, 0, {color:_nf(0,4), range:_n(undefined,127), radius:_n(undefined,187), start:_n(undefined,45), inset:_nf(0,6)}, false) // %7L43
_a(9, 0, {arc:_n(0,7)}, false) // %8L43
_f(6, 0, mul, [_n(undefined,23), _n(0,2)]) // %9L43
_cnp({"Circle":1})
_ae(43, _n(0,8), {top:_n(undefined,45), left:_n(0,9), width:_n(undefined,177), height:_n(undefined,177)}, undefined, {"0":_n(undefined,188)}) // area template expr 43
...
_sp(0, 1) // %3L44<W>
_a(2, 0, {board:_n(0,2), column:_n(undefined,197), row:_n(undefined,199)}, undefined)
_sp(0, 1) // %4L44
_f(3, 0, internalPush, [_n(0,4)])
_sp(0, 1) // %5L44
_f(2, 0, notEmpty, [_n(0,3)])
_sp(0, 1) // %6L44
_f(3, 0, and, [_n(undefined,174), _n(0,6)])
_sp(0, 1) // %7L44
_f(2, 0, last, [_n(0,3)])
_sp(0, 1) // %8L44
_f(3, 0, internalApply, [_n(undefined,9), _n(0,8)])
_sp(0, 1) // %9L44
_f(2, 0, pos, [_n(undefined,201), _n(0,3)])
_sp(0, 1) // %10L44
_f(1, 0, me, [])
_sp(0, 1) // %11L44
...
_ae(44, undefined, {"horizontal-center":_n(undefined,45), height:_n(2,65), width:_n(2,65), "vertical-center":_n(undefined,45)}, undefined, {"0":_n(undefined,194), "1":_n(0,2), "2":_n(0,3)}) // area template expr 44
_aw(44, "onInvert", _n(undefined,172), undefined, {invert:_tm(_n(0,3), _n(0,5), 4)}, undefined, undefined, 2)
...
_f(3, 0, internalApply, [_n(undefined,130), _n(0,1)])
_sp(0, 1) // %4L45
...
_f(5, 0, floor, [_n(0,9)])
_sp(0, 1) // %10L45
_f(6, 0, minus, [_n(0,10), _n(undefined,91)])
_sp(0, 1) // %11L45
_f(7, 0, max, [_n(0,11), _n(undefined,12)])
_sp(0, 1) // %12L45
_f(6, 0, plus, [_n(0,10), _n(undefined,91)])
_sp(0, 1) // %13L45
...
_sp(0, 1) // %22L45
_f(5, 0, minus, [_n(0,17), _n(undefined,91)])
_sp(0, 1) // %23L45
...
_sp(0, 1) // %26L45
_f(5, 0, plus, [_n(0,17), _n(undefined,91)])
_sp(0, 1) // %27L45
...
_m(29, 0, _n(0,81), [_n(undefined,99), _n(undefined,203), _n(undefined,63), _n(undefined,149), _n(undefined,205), _n(undefined,207), _n(undefined,119), _n(undefined,63), _n(undefined,120)]) // %82L45
_q(28, 0, [[_g(_n(0,5), true)], [_g(_n(0,80), true)]]) // %83L45
_m(29, 0, _n(0,83), [_n(undefined,208), _n(undefined,209)]) // %84L45
_a(30, 0, {background:_nf(0,82), transform:_nf(0,84), borderWidth:_n(undefined,116), borderStyle:_n(undefined,117), borderColor:_n(undefined,118)}, false) // %85L45
...
_sp(0, 1) // %90L45
_a(26, 0, {msg:_n(undefined,211), targets:_n(0,79), row:_n(0,10), column:_n(0,17)}, undefined)
_sp(0, 1) // %91L45
_f(4, 0, not, [_n(0,4)])
_sp(0, 1) // %92L45
_f(5, 0, and, [_n(0,2), _n(0,92)])
_sp(0, 1) // %93L45
_a(4, 0, {msg:_n(undefined,211), recipient:_n(undefined,212), targets:_n(0,7)}, undefined)
_sp(0, 1) // %94L45
_f(5, 0, internalApply, [_n(0,94), _n(undefined,0)])
_sp(0, 1) // %95L45
_cnp({"InvertCell":1,"InvertROCell":2,"FixedMatrixCell":3})
_ae(45, _n(0,85), {top:_n(0,87), left:_n(0,89), height:_n(3,63), width:_n(1,17)}, undefined, {"0":_n(undefined,210), "6":_n(0,5), "7":_n(0,79), "8":_n(0,6)}) // area template expr 45
...
_a(4, 0, {image:_n(undefined,213), filter:_n(undefined,30), padding:_nf(0,4)}, false) // %5L46
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %6L46
_q(2, 0, [[_g(_n(0,2), false)]])
_sp(0, 1) // %7L46
...
_ae(46, _n(0,5), {right:_n(1,8), top:_n(1,10), width:_n(undefined,34), height:_n(undefined,34)}, undefined, {"0":_n(undefined,214)}) // area template expr 46
_aw(46, "onClick", _n(0,6), undefined, {sendUndo:_tm(_n(undefined,0), _n(undefined,215), 3)}, undefined, undefined, 2)
...
_a(4, 0, {image:_n(undefined,216), filter:_n(undefined,30), padding:_nf(0,4)}, false) // %5L47
_f(1, 0, internalApply, [_n(undefined,35), _n(0,0)])
_sp(0, 1) // %6L47
_q(2, 0, [[_g(_n(0,2), false)]])
_sp(0, 1) // %7L47
...
_sp(0, 1) // %14L47
_cnp({"IconButton":1,"DepressWhileMouseDown":2,"Clickable":3})
_ae(47, _n(0,5), {top:_n(1,13), right:_n(1,15), width:_n(undefined,34), height:_n(undefined,34)}, undefined, {"0":_n(undefined,214)}) // area template expr 47
